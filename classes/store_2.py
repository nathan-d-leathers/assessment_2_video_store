...
class Store2:
    ...
    def return_video(self,user_id,title_search):
        ...
        # print("Be Kind, Rewind! Thanks for Returning Your Rentals!")
        # code is retreiving message.
        # next need to find member, remove from current rentals list
        # find video in video inventory and add copy to shelf
        
# 
# -=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-=-==-=-=-=-=-=-=-=-=-=-
# ********
# bobs_store = Store2("Bobby's Crazy Video Shack")
# print(type(bobs_store.rental_members))
# <class 'list'>
# need to make a copy or find a way to add new customer to list
# *******



# print(bobs_store.view_rental_list())
# output:
...
# bobs_store.return_video('6','Deadpool')
